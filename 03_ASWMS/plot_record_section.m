% code to plot record section of events with amplitudes on the same scale
...
%             end
            ...
            if is_dist
                ...
                %wbh this doesn't seem to work, the .snr isn't there. 
                if isfill
                    data(find(data > 0)) = 0;
...
%         end
        ...
        stemp = sprintf('Event: %s, M%.2f',event.id,event.Mw);
