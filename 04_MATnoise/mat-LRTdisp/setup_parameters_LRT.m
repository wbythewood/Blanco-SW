...
% CCF Prefilt Periods
CCFMinT = 3;%10; % min period in seconds
CCFMaxT = 60;%50; % max period in seconds
...
parameters.LRTIfnPath = [parameters.MatDbDir,'LRT/CCF_',StaSelectionString,'-',CCFString,'/',IDString,'/PreparedData/'];
% Output LRT panel path (a1)
parameters.LRTpath = [parameters.MatDbDir,'LRT/CCF_',StaSelectionString,'-',CCFString,'/',IDString,'/',num2str(1/f_max),'_',num2str(1/f_min),'s/'];

% Output path for dispersion picks (a3)
parameters.pickspath = [parameters.LRTpath,'picks/'];
